...
export default function Footer() {
  ...
  const floatA = useSpring(useTransform(scrollYProgress, [0, 1], [0, -50]), {
    stiffness: 50,
    damping: 18,
  });
  const floatB = useSpring(useTransform(scrollYProgress, [0, 1], [0, 70]), {
    stiffness: 50,
    damping: 18,
  });
    ...
    <footer className="relative isolate overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 md:py-24">
            ...
            <motion.div variants={itemVariants} initial="hidden" whileInView="show" className="flex gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 mt-2 text-cyan-300 hover:underline text-sm"
                >
        ...
        <div className="pt-6 text-center text-sm text-white/60">
          {language === "ar"
            ? "جميع الحقوق محفوظة. مصنع نعيم © 2026"
            : "© 2026 Naeem Factory. All rights reserved."}
        </div>
      </div>
    </footer>
  );
